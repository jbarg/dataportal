...
/**
	...
	*/
public class SeekNWriteParams extends edu.sdsc.matrix.srb.parser.impl.
			SeekNWriteParamsImpl {
	/**
		...
		*/
	public SeekNWriteParams(DataSet dataSet, String offset, String length) {
