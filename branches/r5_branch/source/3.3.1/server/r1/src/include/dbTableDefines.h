...
int processAllVarsInBuffer (tableStateInfo *stateInfo, char *givenForm,
                            char **retForm);
int
updateVarList(varsList *listName, char *varName, char *varValue, char *varType);int processAllVarsInBuffer (tableStateInfo *stateInfo, char *givenForm,
                            char **retForm);
int
updateVarList(varsList *listName, char *varName, char *varValue, char *varType);int
