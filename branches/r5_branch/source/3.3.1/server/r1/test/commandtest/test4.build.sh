...
for store1 in $storeset ; do
 ...
 $binDir/Spwd
 $binDir/Sput -S $store1 data_1 a_b_1 
 $binDir/Sput -S $store1 data_1 a_b_2 
 $binDir/Sput -S $store1 data_1 a_c_1
 $binDir/Sput -S $store1 data_1 a_c_2
 $binDir/Sput -S $store1 data_1 ab__2
 $binDir/Sput -S $store1 data_1 a___2
 $binDir/Sls -lr 
 $binDir/Sls -lr  ..
 $binDir/Sls -lr  '../*b*'
 $binDir/Sls -lr  ../..
 ...
 $binDir/Scd ..
 $binDir/Spwd
 $binDir/Sput -S $store1 data_1 'C2_a*_*/a_d_1' 
 $binDir/Sput -S $store1 data_1 'C2_a*_*/adb_1' 
 $binDir/Sput -S $store1 data_1 'C2_*o*/a_d_2'
 $binDir/Sls -lr 
 $binDir/Scd ../..
 $binDir/Spwd
 $binDir/SgetD -a -W -L 100 wctest-$testid/\*/\*/\* 
 ...
 $binDir/Sls -lr wctest-$testid 
 $binDir/Schmod -r a sekar sdsc  wctest-$testid
 $binDir/SgetD -a -W -L 100 wctest-$testid/\*/\*/\* 
 $binDir/Srm -rf wctest-$testid
 $binDir/Sexit
done
echo "test completed..."
exit 0
