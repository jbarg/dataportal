...
/**
 * Split full path with data/file name to path and dataname. Useful when combined
 * with srcNameArray. 
 *
 * @param myinname full path and data name
 * @param collname preallocated collection name
 * @param dataname preallocated dataname.
 * @return none.
 */
...
int
lsContainer (srbConn *conn, char *containerName, char *userName, 
char *domainName, int flagval,
