...
public class MatrixQueryParser /*@bgen(jjtree)*/ implements
			MatrixQueryParserTreeConstants, MatrixQueryParserConstants {
	/*@bgen(jjtree)*/
	protected static JJTMatrixQueryParserState jjtree = new
				JJTMatrixQueryParserState();
	// Initialize MatrixQuery
	public static MatrixQueryProcessor queryProcessor = new
				MatrixQueryProcessor();
	...
	public static void main(String args[]) {
		...
		MatrixQueryParser t = new MatrixQueryParser(new StringReader(
					queryString));
		try {
			ASTStart n = t.Start();
	...
	static final public void ModuleDecl() throws ParseException {
		...
		try {
			...
			jjtc000 = false;
			{
				if (true) {
					throw new ParseException(
								"ModuleDecl - Feature Not Supported in Matrix: " + t1);
				}
			}
		} catch (Throwable jjte000) {
			if (jjtc000) {
	...
	static final public void Version() throws ParseException {
		...
		try {
			...
			jjtc000 = false;
			{
				if (true) {
					throw new ParseException(
								"Version - Feature Not Supported in Matrix:" + t1);
				}
			}
		} catch (Throwable jjte000) {
			if (jjtc000) {
	...
	static final public void ModuleImport() throws ParseException {
		...
		try {
			...
			jjtc000 = false;
			{
				if (true) {
					throw new ParseException(
								"ModuleImport - Feature Not Supported in Matrix:" + t1);
				}
			}
		} catch (Throwable jjte000) {
			if (jjtc000) {
	...
	static final public String ExprSingle() throws ParseException {
		...
		MatrixUtil.toLog(
					"MatrixQueryParser-ExprSingle()- isReturnClauseInProcess:" +
					isReturnClauseInProcess, MatrixUtil.DEBUG_LOG);
		MatrixUtil.toLog("EXPR SINGLE expression:" + expression,
							MatrixUtil.DEBUG_LOG);
		// Processing Selection Fields For Return Clause
		if (isReturnClauseInProcess) {
			if (expression != null) {
				if (expression.trim().length() > 0) {
					queryProcessor.getReturnClause().addSelectionFieldName(
								expression);
				}
			}
		}
	...
	static final public void FLWORExpr() throws ParseException {
		...
		MatrixUtil.toLog("RETURN EXPRESSION :" + returnExpression,
							MatrixUtil.DEBUG_LOG);
		isReturnClauseInProcess = false;
		queryProcessor.getReturnClause().setReturnExpression(returnExpression);
		queryProcessor.getReturnClause().
					fixToRemoveReturnExpresionFromSelectionFieldNames();
	}
	...
	static final public void ForClause() throws ParseException {
		...
		queryProcessor.getForClause().setFunctionName(forExpression.substring(0,
					forExpression.indexOf('(')));
		queryProcessor.getForClause().setFunctionParameter(forExpression.
																	substring(
					forExpression.indexOf('"') + 1, forExpression.lastIndexOf('"')));
	}
	...
	static final public String ComparisonExpr() throws ParseException {
		...
		if (jj_2_65(2)) {
			...
			expr = expr + tempExpr;
			wVal = tempExpr;
			MatrixQueryConditionClause condClause = new
						MatrixQueryConditionClause();
	...
	static final public String IntersectExceptExpr() throws ParseException {
		...
		MatrixUtil.toLog("INTERSECT EXCEPT EXPR : " + expr,
							MatrixUtil.DEBUG_LOG);
		{
			if (true) {
				return expr;
	...
	static final public void ComputedDocumentConstructor() throws
				ParseException {
	...
	static final public void ComputedAttributeConstructor() throws
				ParseException {
		if (jj_2_171(2)) {
			jj_consume_token(ATTRIBUTE);
			QName();
	...
	static final private boolean jj_3_255() {
		if (jj_scan_token(VALIDATION)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
		}
		if (jj_scan_token(SKIPTOKEN)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_259() {
		if (jj_scan_token(DEFAULTTOKEN)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
		}
		if (jj_scan_token(ELEMENT)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3R_132() {
		if (jj_scan_token(PROCESSINGINSTRUCTION)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3R_94() {
		if (jj_scan_token(PROCESSINGINSTRSTART)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_153() {
		if (jj_scan_token(DESCENDANT_OR_SELF)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_141() {
		if (jj_scan_token(GREATERTHANGREATERTHAN)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_140() {
		if (jj_scan_token(LESSTHANLESSTHAN)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_131() {
		if (jj_scan_token(NOT_BETWEEN_OPERATOR)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_130() {
		if (jj_scan_token(BETWEEN_OPERATOR)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_129() {
		if (jj_scan_token(NOT_IN_OPERATOR)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_127() {
		if (jj_scan_token(SOUNDS_NOT_LIKE_OPERATOR)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_126() {
		if (jj_scan_token(SOUNDS_LIKE_OPERATOR)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_125() {
		if (jj_scan_token(NOT_LIKE_OPERATOR)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static final private boolean jj_3_124() {
		if (jj_scan_token(LIKE_OPERATOR)) {
			return true;
		}
		if (jj_la == 0 && jj_scanpos == jj_lastpos) {
			return false;
	...
	static private void jj_add_error_token(int kind, int pos) {
		...
		if (pos == jj_endpos + 1) {
			...
			for (java.util.Enumeration enum_1 = jj_expentries.elements();
					enum_1.hasMoreElements(); ) {
				int[] oldentry = (int[]) (enum_1.nextElement());
