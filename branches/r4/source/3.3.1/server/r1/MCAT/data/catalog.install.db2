...
create table MDAS_TD_DATA_GRP                  
	(data_grp_id     varchar(250)  not null,	    
	 data_grp_name      varchar(500) not null ,	    
	 parent_grp_name      varchar(500) not null ,
         coll_owner integer,
         ...
         coll_link       integer  not null DEFAULT 0,
...
create table MDAS_AD_REPL
	 ...
	 modify_timestamp varchar(32),	    
         ...
         version_num    varchar(250) not null DEFAULT '0',
         ...
         seg_num integer not null DEFAULT -1,
...
create table MDAS_AD_STRCT_BLOB 
	(strblngsto_data_id integer  not null,	     
	 ...
	 internal_structure varchar(2000)
	)  ;
...
create table MDAS_AR_TAPE_INFO
         ...
         tapeOwner      varchar(400),
         tapeType       char(10),
         tapeLibInx     integer,
         fullFlag       integer,
         currentFileSeqNum   integer,
         currentAbsPosition  varchar(400),
         bytesWritten        integer
        )  ;

create table DC_TD_CONTR_TYPE
        (
	 dc_contr_type_name varchar(400)    not null,
...
create table DC_TD_SUBJ_CLASS
        (
	 dc_subj_class_name varchar(400)    not null,
	 dc_subj_class_id varchar(250)      not null,
         primary key (dc_subj_class_id)
        )  ;

create table DC_TD_DESCR_TYPE
        (
	 dc_desc_type_name varchar(400)     not null,
...
create table DC_TD_TYPE
        (
	 dc_type_name varchar(400)         not null,
...
create table DC_TD_SOURCE_TYPE
        (
	 source_type_name varchar(400)     not null,
...
create table DC_TD_RELATION_TYP
        (
	 relation_type_name varchar(400)   not null,
...
create table DC_TD_COVERAGE
        (
	 coverage_type_name varchar(400)   not null,  
...
create table DC_TD_RIGHTS
        (
	 rights_type_name varchar(400)   not null,  
...
create table DC_AUTHCONTRIB
        (
         ...
         dc_contr_name varchar(400)         not null,
         dc_contr_corp_name varchar(400),
         dc_contr_type_id integer        not null,
         dc_contr_email  varchar(400),
...
create table DC_SUBJECT
	(
	 dc_subject_name varchar(400)       not null,
	 dc_subj_class_id varchar(250)      not null,
	 data_id integer                 not null,
	 repl_enum integer               not null
	)  ;
...
create table DC_PUBLISHER
	(
	 dc_pub_name varchar(400)          not null,
	 dc_pub_addr varchar(400)          not null,
	 data_id integer                 not null,
	 repl_enum integer               not null
	)  ;
...
create table DC_SOURCE
	(
	 source_desc varchar(400)          not null,
	 source_type_id integer       not null,
	 data_id integer                 not null,
	 repl_enum integer               not null
	)  ;
...
create table DC_COVERAGE
	(
	 coverage_desc varchar(400)        not null,  
	 coverage_type_id integer     not null,  
	 data_id integer                 not null,
	 repl_enum integer               not null
	)  ;
...
iinsert into mdas_audit_desc (actionDesc,actionid) values ('D_INSERT_GUID',168);
