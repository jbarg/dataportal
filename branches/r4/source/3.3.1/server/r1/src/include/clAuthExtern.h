...
/* Environment variable names for an alternative .MdasAuth file
   with scrambled contents (Sauth utility): */
#define AUTH_FILENAME_DEFAULT     ".srb/.srbAuthFile"
#define AUTH_FILENAME_ENV_VAR_NAME "SRB_AUTH_FILE"
#define AUTH_ADDITIONAL_KEY_ENV_VAR_NAME "SRB_AUTH_KEY"
...
extern int clSendAuth (srbConn *conn);
