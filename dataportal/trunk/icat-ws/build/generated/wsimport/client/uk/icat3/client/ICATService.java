 ...
 * 
 */
@WebServiceClient(name = "ICATService", targetNamespace = "client.icat3.uk", wsdlLocation = "ICAT.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "ICAT.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'ICAT.wsdl', retrying as a local file");
