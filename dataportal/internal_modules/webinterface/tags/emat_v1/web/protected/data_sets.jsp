                                                            ...
                                                            <a4j:form id="helpform">
                                                                ...
                                                                <t:collapsiblePanel  id="help" value="#{helpCollapsibleBean.collapsed}" title="testTitle" >
                                                                    ...
                                                                    <h:panelGrid width="600" style="font: 11px Verdana, Arial, Helvetica, sans-serif; background-color:#CCCCCC; ">
                                                                        ...
                                                                        <h:outputText value="From here you can either add investigation(s) to the 'Bookmarks' by checking the box next the investigation and the press 'Add to Data Center' or add data files or data sets to the 'Data References' by doing the same."/>
