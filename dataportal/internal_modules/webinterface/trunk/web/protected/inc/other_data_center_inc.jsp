                ...
                <td>
                    <a4j:region   selfRendered="true" > 
                        ...
                        <t:dataTable rendered="#{otherdatacenterBean.populated}" id="datatable" width="100%"
                                     ...
                                     columnClasses="standardTable_Column,standardTable_Column,standardTable_ColumnCentered, standardTable_ColumnCentered, standardTable_ColumnCentered,standardTable_ColumnCentered,standardTable_ColumnCentered,standardTable_ColumnCentered,standardTable_ColumnCentered"
                                     var="data"
                            ...
                            <h:column>
                                ...
                                <h:panelGrid columns="4" rendered="#{!data.dataset}">
                                    ...
                                    <h:commandLink disabled="true" rendered="#{!data.dataset}" onclick="download('#{data.facility}-#{data.id}','#{data.typeOfReference}_IMAGEJ','DATA_CENTER'); return false;" style="color:black" id="view">                                                        
                            ...
                            <h:column>
                                ...
                                <h:panelGrid columns="3">   
                                    <h:commandLink disabled="true" onclick="download('#{data.dpId}','#{data.typeOfReference}','DATA_CENTER'); return false;" style="color:black" id="downloadname" actionListener="#{datacenterBean.download}">
                           ...
                           <%-- <h:column>
                                ...
                                <h:selectBooleanCheckbox  value="#{data.download}" style="background-color:#D1E4E4" title="Add to download"  immediate="true" >                                                    
                                    <a4j:support reRender="message,downloademail,downloadnow" event="onclick" ajaxSingle="true" immediate="true" actionListener="#{otherdatacenterBean.setDataFileDownloadAction}">
                                        <a4j:actionparam name="datafiles" value="#{data.dpId}" />
                                        <a4j:actionparam name="DATA_FILE"  />
                                    </a4j:support>
                                </h:selectBooleanCheckbox>
                            ...
                            <h:column>
                                ...
                                <t:popup styleClass="popup"  closePopupOnExitingElement="true"
                                    ...
                                    <f:facet name="popup">
                                        <h:panelGrid columns="1" >
                                            <h:commandLink action="#{otherdatacenterBean.viewData}" title="View investigation" value="Investigation"/>
                                            <h:commandLink action="#{otherdatacenterBean.viewDataSets}" title="View datasets" value="Datasets"/>                                                            
                                        </h:panelGrid>
                                    </f:facet>
                                </t:popup>
                            ...
                            <f:facet name="detailStamp">
                                ...
                                <t:dataTable preserveSort="true" rendered="#{data.dataset}" width="95%" id="cities" styleClass="standardTable_Column" var="url" value="#{data.urls}">
                                    ...
                                    <h:column>
                                        ...
                                        <h:commandLink disabled="true" rendered="#{url.imageJ}" onclick="download('#{url.dpId}','DATA_FILE_IMAGEJ','DATA_CENTER'); return false;" style="color:black" id="view">
                                            <t:graphicImage id="doc_button"  value="../../images/document.png"  border="0"/>
                                            
                                        </h:commandLink>
                                        
                                        <h:commandLink disabled="true" onclick="download('#{url.dpId}','DATA_FILE','DATA_CENTER'); return false;" style="color:black" id="downloadname" actionListener="#{datacenterBean.download}">
