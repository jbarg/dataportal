                ...
                <td>
                    <table width="100%" border="0">
                         <tbody>
                            ...
                            <%--<c:if test="${fn:length(requestScope.historyBean.history) > 0}" >--%>

                            <tr>
                                <td>
                                    <t:dataTable id="datatable" width="100%"
                                    ...
                                    <%--</c:if>--%>
                                    <c:if test="${fn:length(requestScope.historyBean.history) > sessionScope.visit.userPreferences.resultsPerPage}" >
