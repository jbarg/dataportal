...
SERVER_PORT NUMBER,
SERVER_CONTEXT_ROOT VARCHAR2(100),
DOWNLOAD_LOCATION VARCHAR2(4000),
LOGGING_LEVEL VARCHAR2(20),
MOD_TIME TIMESTAMP(1) NOT NULL
)
;
...
insert into DP_PROXY_SERVERS values (1,'myproxy.grid-support.ac.uk', 7512, '/C=UK/O=eScience/OU=CLRC/L=DL/CN=host/myproxy.grid-support.ac.uk/E=a.j.richards@dl.ac.uk','N',systimestamp);
insert into DP_PROXY_SERVERS values (2,'myproxy-sso.grid-support.ac.uk', 7512, '/C=UK/O=eScience/OU=CLRC/L=RAL/CN=myproxy-sso.grid-support.ac.uk/E=support@grid-support.ac.uk', 'Y', systimestamp);

insert into DP_FACILITY values (1,'DIAMOND', 'Diamond Project','http://www.diamond.ac.uk/', systimestamp);
--insert into DP_FACILITY values (3,'ISIS', 'ISIS Pulsed Neutron \& Muon Source','http://www.isis.rl.ac.uk/', systimestamp); 
--insert into DP_FACILITY values (2,'EMAT', 'E-Materials Project','http://www.emat.rl.ac.uk/', systimestamp);
--insert into DP_MODULE_LOOKUP values (1,'null', 'user', 'password', 'oracle', 'dpal', 'ISIS', 'Y','N','N','N','Y', systimestamp) ;
--insert into DP_MODULE_LOOKUP values (2, 'null', 'user', 'password', 'oracle', 'dpal', 'EMAT', 'Y','N','N','N','Y', systimestamp) ;

insert into DP_MODULE_LOOKUP values (1, 'null', 'user', 'password', 'oracle', 'dpal', 'DIAMOND', 'Y','N','N','N','Y', systimestamp) ;

insert into DP_EVENT values (1,'LOG_OFF','',systimestamp);
insert into DP_EVENT values (2,'LOG_ON','',systimestamp);
insert into DP_EVENT values (6,'LOG_ON_KERBEROS','',systimestamp);
