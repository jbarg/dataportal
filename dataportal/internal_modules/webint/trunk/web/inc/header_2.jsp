...
<%@ taglib uri="http://java.sun.com/jsf/html" prefix="h"%>
 ...
 <h:form>
     <t:jscookMenu layout="hbr" theme="ThemeOffice" styleLocation="css/jscookmenu">
         ...
         <t:navigationMenuItem id="nav_1"  itemLabel="Basic Search" itemValue="go_home" action="go_home"/>
         <t:navigationMenuItem id="nav_2"  itemLabel="Investigations" action="go_home" />
