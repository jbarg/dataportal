...
public class TestDPAccessLayerDls
{
   ...
   public static void main(String []args)
   {
     ...
     DPAccessLayer dpal = new DPAccessLayer("dls", "jdbc:oracle:thin:@(DESCRIPTION=(LOAD_BALANCE=on)(ADDRESS=(PROTOCOL=TCP)(HOST=honey-vip.esc.rl.ac.uk) (PORT=1521))(ADDRESS=(PROTOCOL=TCP)(HOST=goodnight-vip.esc.rl.ac.uk)(PORT=1521))(ADDRESS=(PROTOCOL=TCP)(HOST=sapphire-vip.esc.rl.ac.uk)(PORT=1521))(ADDRESS=(PROTOCOL=TCP)(HOST=domino-vip.esc.rl.ac.uk)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=icatdls.esc.rl.ac.uk)))", "icatdls", "kjadh31") ;
