/**
 * Xmlwrapper_MpimSoapBindingStub.java
 *
...
public class Xmlwrapper_MpimSoapBindingStub extends org.apache.axis.client.Stub implements uk.ac.cclrc.xmlwrapper.ws.mpim.XmlWrapperMPIM {
    private java.util.Vector cachedSerClasses = new java.util.Vector();
    private java.util.Vector cachedSerQNames = new java.util.Vector();
    private java.util.Vector cachedSerFactories = new java.util.Vector();
    private java.util.Vector cachedDeserFactories = new java.util.Vector();

    public Xmlwrapper_MpimSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public Xmlwrapper_MpimSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Xmlwrapper_MpimSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
