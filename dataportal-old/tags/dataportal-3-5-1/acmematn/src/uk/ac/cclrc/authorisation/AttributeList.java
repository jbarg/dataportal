...
public class AttributeList {
   ...
   /* public AttributeList(String userDn,String facilityName, String issuerDn, String notBefore, String  notAfter) throws ClassNotFoundException,SQLException {
    ...
    String issuerSerialNumber, int[] notBefore, int[] notAfter, String aDPView, String aWrapperGroup, String aDataAccessGroup) throws ClassNotFoundException,SQLException {
    ...
    public Document getJDOMDocument() {
            ...
            Element attributesDPViewElement = new Element("DPView");
            attributesDPViewElement.setText(aDPView);
            //set Attributes Wrapper Group
            Element attributesWrapperGroupElement = new Element("wrapperGroup");
            attributesWrapperGroupElement.setText(aWrapperGroup);
            ...
            attributesElement.addContent(attributesDPViewElement);
            attributesElement.addContent(attributesWrapperGroupElement);
    ...
    private String aDPView;
    private String aWrapperGroup;
