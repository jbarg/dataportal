                ...
                File[] filename = new File [(list2.length)];
                 ...
                 if(list2.length == 1) {
                   //System.out.print("trying to parse "+wd+File.separator+"profiles"+File.separator+conf.getProperty(list2[0]).trim()+sid);
                    doc = XML_DOMBuilder.parse(new File(wd+File.separator+"profiles"+File.separator+conf.getProperty(list2[0]).trim()+sid));
                     ...
                     for(int i = 0 ; i< list2.length;i++){
                        ...
                        filename[i] = new File(wd+File.separator+"profiles"+File.separator+conf.getProperty(list2[i]).trim()+sid);
