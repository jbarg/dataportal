...
//needed for new xml exception thrown by integration
...
public class XmlWrapperDocSelector
{
                                                                         ...
                                                                         UserNotAuthorisedException
   {
      ...
      try
      {
         ...
         log.debug("metadata access is xxxx:" + wrapper_access + ":xxxx") ;

         if ((wrapper_access.compareTo("f") == 0) || (wrapper_access.compareTo("F") == 0 ) )
         {
      ...
      catch (Exception e)
      {
         ...
         if(e instanceof UserNotAuthorisedException)
         {
            throw new UserNotAuthorisedException(e.getMessage()) ;
         }
         ...
         else if (e instanceof InvalidAuthorisationTokenException)
         {
            throw new InvalidAuthorisationTokenException(e.getMessage()) ;
         }
         else if (e instanceof SAXParseException)
         {
            throw new InvalidAuthorisationTokenException ("Authorisation Token not supplied or not well formed XML") ;
         }
      }
