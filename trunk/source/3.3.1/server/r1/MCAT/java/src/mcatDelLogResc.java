...
/*****************************************************************************/
/*                                                                           */
/*  WHAT:   mcatDelLogResc.java                                              */
/*                                                                           */
/*  WHY:    Delete a Logical Resource                                        */
 ...
 *
 */
public class mcatDelLogResc extends JFrame {
    // Insets
    ...
    private static String rescMsgStr = "Select a logical resource : ";
    ...
    public mcatDelLogResc(SRBFileSystem srbFileSystem)
    {
	fileSystem = srbFileSystem;

	setTitle (new String ("Delete Logical Resource panel"));
	...
	// Resc Name List
        ...
        ActionListener executeListener = new ActionListener() {
            public void actionPerformed( ActionEvent e ) {
                ...
                msgText.append (new String (
		     "Deleting logical resource: " + selRescName  + "\n"));
		try {
		    fileSystem.srbDeleteValue( fileSystem.DELETE_TYPE_RESOURCE,
					       selRescName );
		    msgText.append (new String (
		        "Notice: Complete deleting logical resource " 
                        + selRescName +  "\n"));
		    ...
		    msgText.append (new String (
			"Error: Error deleting logical resource. Status = " +
	...
	MetaDataCondition[] conditions = { MetaDataSet.newCondition(
	     ...
	     MetaDataCondition.EQUAL, "logical" ) };
    ...
    public static void main(String[] args) {
        try {
        mcatDelLogResc  myMcatDelLogResc = new 
            mcatDelLogResc(new SRBFileSystem());
        } catch (Exception e) {
            System.exit(0);
        }
    }
