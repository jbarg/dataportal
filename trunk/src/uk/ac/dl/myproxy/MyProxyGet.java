 ...
 * @author  gjd37
 */
public class MyProxyGet extends javax.swing.JDialog {
    
    
    private String _username = "";
    private String _password = "";
    private String _lifetime = "";
    private String _gridpassword = "";
    private GSSCredential proxy = null;
    
    /** Creates new form MyProxy */
    public MyProxyGet(javax.swing.JFrame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lifetime = new javax.swing.JTextField();

        getContentPane().setLayout(new java.awt.GridBagLayout());

        setTitle("MyProxy Retrieval Details");
        setResizable(false);
        ...
        jLabel3.setText("Proxy Lifetime");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        pass1.setNextFocusableComponent(lifetime);
        ...
        lifetime.setNextFocusableComponent(gridpass);
    ...
    private void okActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okActionPerformed
        ...
        _lifetime = lifetime.getText();
        _gridpassword = gridpass.getText();
        
        try{
            Integer.valueOf(_lifetime);
        }
        catch(NumberFormatException e){
            JOptionPane.showMessageDialog(this,"Please enter a integer for the Proxy Lifetime","Need More Information" ,  JOptionPane.WARNING_MESSAGE);
            return;
        }
        if(_username.equals("") || _password.equals("")  ||_gridpassword.equals("")){
            JOptionPane.showMessageDialog(this,"Please enter a value for the username, password and/or  Grid PassPhrase","Need More Information" ,  JOptionPane.WARNING_MESSAGE);
            return;
    ...
    private void myProxyGet() {
        
        final JLabel msgLabel = new JLabel("Retrieving proxy...");
        ...
        if (selectedValue == null || selectedValue == options[0]) {
            ...
            if (e == null) {
                ...
                if (proxy instanceof GlobusGSSCredentialImpl) {
                    ...
                    savedproxy = JOptionPane.showConfirmDialog(this,
                    "Proxy was successfully downloaded.\nSubject:  "+cred.getSubject()+"\nIssuer:  "+cred.getIssuer()+"\nIdentity:  "+cred.getIdentityCertificate().getSubjectDN().toString()+"\nTime Left:  "+Util.formatTimeSec(cred.getTimeLeft())+"\nType:  "+CertUtil.getProxyTypeAsString(cred.getProxyType())+"\nStrength:  "+cred.getStrength()+" bits.\nDo you wish to save the proxy?",
                    "Save Proxy",
                    JOptionPane.YES_NO_OPTION);
                }
                else savedproxy = JOptionPane.showConfirmDialog(this,
                "Proxy was successfully downloaded.\nDo you wish to save the proxy?",
                "Save Proxy",
                JOptionPane.YES_NO_OPTION);
                ...
                if(saveFile == null || saveFile.equals("")){
                    ...
                    try{
                        ExtendedGSSCredential c= (ExtendedGSSCredential)proxy;
                        byte [] data = c.export(ExtendedGSSCredential.IMPEXP_OPAQUE);
                        FileOutputStream out = new FileOutputStream(saveFile);
                        out.write(data);
                        out.close();
                        // set read only permissions if on unix
                        if (!System.getProperty("os.name").startsWith("Windows")){
                            if(!Util.setFilePermissions(saveFile.toString(), 600)) {
                                
                                System.err.println("Warning: Please check file permissions for your proxy file.");
                                JOptionPane.showMessageDialog(this,
                                "Proxy was saved.  Warning: Please check file permissions for your proxy file.\nIt should be read and write only by you.",
                                "Proxy saved",
                                JOptionPane.INFORMATION_MESSAGE);
                                dispose();
                                return;
            ...
            //Show error and explain to the user
                ...
                JOptionPane.showMessageDialog(this,
                "Failed to retrieve proxy: " + e.getMessage()+"\nIs your Grid PassPhrase correct?",
                "Proxy get Error",
                JOptionPane.ERROR_MESSAGE);
                gridpass.setText("");
                setVisible(true);
            }
            else if(e.getMessage().endsWith("invalid pass phrase]")){
                JOptionPane.showMessageDialog(this,
                "MyProxy PassPhrase is incorrect",
                "Proxy get Error",
                JOptionPane.ERROR_MESSAGE);
                pass1.setText("");
                setVisible(true);
    ...
    class Task extends Thread {
        ...
        public void run() {
            try{
                ...
                GlobusCredential delegateCred  = certFactory.createCredential( new X509Certificate[] { X509Cert},issuerKey,strength, 2*3600, GSIConstants.DELEGATION_FULL );
                ...
                proxy = proxy1.get(cred, _username, _password, Integer.parseInt(_lifetime)*3600);
                //save file
                done= true;
                //end of new section
   ...
   /* public static void main(String args[]) {
    ...
    private javax.swing.JTextField lifetime;
