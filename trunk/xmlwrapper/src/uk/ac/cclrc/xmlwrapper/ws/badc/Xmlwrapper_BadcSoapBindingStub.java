/**
 * Xmlwrapper_BadcSoapBindingStub.java
 *
...
public class Xmlwrapper_BadcSoapBindingStub extends org.apache.axis.client.Stub implements uk.ac.cclrc.xmlwrapper.ws.badc.XmlWrapperBADC {
    private java.util.Vector cachedSerClasses = new java.util.Vector();
    private java.util.Vector cachedSerQNames = new java.util.Vector();
    private java.util.Vector cachedSerFactories = new java.util.Vector();
    private java.util.Vector cachedDeserFactories = new java.util.Vector();

    public Xmlwrapper_BadcSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public Xmlwrapper_BadcSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Xmlwrapper_BadcSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public org.w3c.dom.Element getXML(java.lang.String query) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("urn:xmlwrapper", "getXML"));
