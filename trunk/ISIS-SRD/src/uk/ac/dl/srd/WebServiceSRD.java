 ...
 * @version 1.0
 */
public class WebServiceSRD {
    //set static log for the class
    static Logger logger = Logger.getLogger(WebServiceSRD.class);
    ...
    public org.w3c.dom.Element getXML(String query)throws Exception{
        ...
        String srd  = prop.getProperty("srd_url");
        //logger.warn("WARN");
        ...
        try{
            ...
            URL url = new URL(srd+"?where=%20Discipline%20like%27%"+cheating+"%27%20and%20DMInstitutionName%20like'%SRS%';UserID=dpuser;");
            ...
            logger.warn("Uanble to return XML from SRD",e);
            throw e;
        }
        //return the element
        return el;
