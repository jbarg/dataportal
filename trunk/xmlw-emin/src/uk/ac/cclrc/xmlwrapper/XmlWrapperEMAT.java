...
public class XmlWrapperEMAT
{
   ...
   //change
   public XmlWrapperEMAT()
   {
      SessionSingleton ss = SessionSingleton.getInstance() ;
      
      //setup wrapper name
      ss.setWrapperName("emat") ;

      //setup logger
      ss.setLogger(XmlWrapperEMAT.class.getName() + ".class" ) ;
   ...
   public org.w3c.dom.Element getXML(String query) 
   {
      ...
      //change
      CsmdMapper cm = CsmdMapperFactory.create("emat") ;
