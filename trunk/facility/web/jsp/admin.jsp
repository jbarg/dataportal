...
<hr />
<br />
<form name="dataportal_creation" action="../servlet/CreateDataPortal" method="post">
<table>
<tr><td width="200"><b>DataPortal (ID)</b></td><td width="20">&nbsp;</td><td><input name="dataportal_id" type="text" size="70" value="DataPortal"></input></td></tr>
...
<tr><td width="200">URL Endpoint</td><td width="20">&nbsp;</td><td><input name="acm" type="text" size="70" value="http://localhost:8080/queryandreply/services/QueryAndReply"></input></td></tr>
<tr><td width="200">WSDL Endpoint</td><td width="20">&nbsp;</td><td><input name="acm_wsdl" type="text" size="70" value="http://localhost:8080/queryandreply/services/QueryAndReply?wsdl"></input></td></tr>
<tr><td width="200">Description </td><td width="20">&nbsp;</td><td><input name="acm_desc" type="text" size="70" value="Query and Reply"></input></td></tr>

<tr><td rows="3">&nbsp;</td></tr>
<tr><td width="200">Name </td><td width="20">&nbsp;</td><td>Data Transfer</td></tr>
<tr><td width="200">Type </td><td width="20">&nbsp;</td><td>DTM</td></tr>
<tr><td width="200">URL Endpoint</td><td width="20">&nbsp;</td><td><input name="dtm" type="text" size="70" value="http://localhost:8080/datatransfer/services/DataTransferService"></input></td></tr>
<tr><td width="200">WSDL Endpoint</td><td width="20">&nbsp;</td><td><input name="dtm_wsdl" type="text" size="70" value="http://localhost:8080/datatransfer/services/DataTransferService?wsdl"></input></td></tr>
<tr><td width="200">Description </td><td width="20">&nbsp;</td><td><input name="dtm_desc" type="text" size="70" value="Data Transfer"></input></td></tr>

<tr><td rows="3">&nbsp;</td></tr>
<tr><td width="200">Name </td><td width="20">&nbsp;</td><td>Session Manager</td></tr>
<tr><td width="200">Type </td><td width="20">&nbsp;</td><td>SESSION</td></tr>
<tr><td width="200">URL Endpoint</td><td width="20">&nbsp;</td><td><input name="acm" type="text" size="70" value="http://localhost:8080/sessionmanager/services/SessionManager"></input></td></tr>
<tr><td width="200">WSDL Endpoint</td><td width="20">&nbsp;</td><td><input name="acm_wsdl" type="text" size="70" value="http://localhost:8080/sessionmanager/services/SessionManager?wsdl"></input></td></tr>
<tr><td width="200">Description </td><td width="20">&nbsp;</td><td><input name="acm_desc" type="text" size="70" value="Session Manager"></input></td></tr>	
