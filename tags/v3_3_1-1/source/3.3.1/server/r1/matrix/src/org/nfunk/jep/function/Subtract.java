...
public class Subtract extends PostfixMathCommand
{
	...
	{
       // Jon (7/6/04)
       // if either of the parameters are not numbers then we just concat their
       // string representations
       if ( !(param1 instanceof Number || param1 instanceof Complex) ||
            !(param2 instanceof Number || param2 instanceof Complex))
	  {
	    return FunctionUtils.getString(param1)+"-"+FunctionUtils.getString(param2);
	  }
