...
/**
 * Java content class for ListOp complex type.
 ...
 *       &lt;choice>
 *         &lt;element name="StdParams" type="{http://www.teragrid.org/schemas/datagrid}ListParams"/>
...
public interface ListOp {
    ...
    edu.sdsc.matrix.srb.parser.ListParams getStdParams();

    void setStdParams(edu.sdsc.matrix.srb.parser.ListParams value);
