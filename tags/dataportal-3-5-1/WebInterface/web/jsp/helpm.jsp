...
ArrayList getList(String text){
    ...
    //try again
      ...
      //  System.out.<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<%
 ...
 //need to read in the xml as a string , replace the search string, the transform
    ...
    String[] colours =  {"yellow","red","blue","green","black","gray"};
    String newxml = null;
   ...
   //replace the seacrh string    
     newxml = replaceatt(xml.toString(),text,"<span class='"+colours[j]+"'>"+text+"</span>");
       }
    //build xml into dom
...
println("size of the list is "+a.get(0));
     //System.out.println("size of the list is "+a.get(1));
     //System.out.println("size of the list is "+a.get(2));
        for(int si = 0 ; si < a.size(); si++){
            if(a.get(si).equals("")){
