/**
 * Xmlwrapper_EmatSoapBindingStub.java
 *
...
public class Xmlwrapper_EmatSoapBindingStub extends org.apache.axis.client.Stub implements uk.ac.cclrc.xmlwrapper.ws.emat.XmlWrapperEMAT {
    private java.util.Vector cachedSerClasses = new java.util.Vector();
    private java.util.Vector cachedSerQNames = new java.util.Vector();
    private java.util.Vector cachedSerFactories = new java.util.Vector();
    private java.util.Vector cachedDeserFactories = new java.util.Vector();

    public Xmlwrapper_EmatSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public Xmlwrapper_EmatSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public Xmlwrapper_EmatSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
