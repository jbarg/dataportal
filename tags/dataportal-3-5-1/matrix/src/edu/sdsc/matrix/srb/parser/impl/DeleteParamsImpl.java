...
public class DeleteParamsImpl implements edu.sdsc.matrix.srb.parser.DeleteParams, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
    ...
    public edu.sdsc.matrix.srb.parser.StdDatagridObject getGridObject() {
        return _GridObject;
    }

    public void setGridObject(edu.sdsc.matrix.srb.parser.StdDatagridObject value) {
        _GridObject = value;
    }

    public com.sun.xml.bind.unmarshaller.ContentHandlerEx getUnmarshaller(com.sun.xml.bind.unmarshaller.UnmarshallingContext context) {
        return new edu.sdsc.matrix.srb.parser.impl.DeleteParamsImpl.Unmarshaller(context);
    }
    ...
    {
        if (_GridObject instanceof javax.xml.bind.Element) {
            context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _GridObject));
        } else {
            context.startElement("http://www.teragrid.org/schemas/datagrid", "gridObject");
            context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _GridObject));
        ...
        if (has_Force) {
            context.startElement("http://www.teragrid.org/schemas/datagrid", "force");
            context.endAttributes();
            try {
                context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _Force)));
            } catch (java.lang.Exception e) {
                com.sun.xml.bind.marshaller.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        ...
        extends com.sun.xml.bind.unmarshaller.ContentHandlerEx
    {
        ...
        protected com.sun.xml.bind.unmarshaller.UnmarshallableObject owner() {
            return edu.sdsc.matrix.srb.parser.impl.DeleteParamsImpl.this;
        }
            ...
            throws com.sun.xml.bind.unmarshaller.UnreportedException
        {
            switch (state) {
                case  3 :
                    if (("http://www.teragrid.org/schemas/datagrid" == ___uri)&&("force" == ___local)) {
                ...
                case  1 :
                    if (("http://www.teragrid.org/schemas/datagrid" == ___uri)&&("DataSetNow" == ___local)) {
                        _GridObject = ((edu.sdsc.matrix.srb.parser.impl.StdDatagridObjectImpl) spawnChildFromEnterElement((edu.sdsc.matrix.srb.parser.impl.StdDatagridObjectImpl.class), 2, ___uri, ___local, __atts));
                        return ;
                    }
                    ...
                    break;
                case  0 :
                    if (("http://www.teragrid.org/schemas/datagrid" == ___uri)&&("gridObject" == ___local)) {
                        context.pushAttributes(__atts);
                        state = 1;
                        return ;
                    }
            ...
            throws com.sun.xml.bind.unmarshaller.UnreportedException
        {
            try {
                switch (state) {
                    ...
                    case  6 :
                        try {
                            _Force = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                            has_Force = true;
                        } catch (java.lang.Exception e) {
                            handleParseConversionException(e);
                        }
