...
$SRB_FILE="SRB3.3.0rel_pgp.tar";  # The SRB tar file
$SRB_FILE_ALREADY_DECRYPTED=0;    # Set this to 1 if the SRB Tar file is
                                  # already  decrypted (e.g., you did it 
                                  # manually).
$SRB_DIR="SRB3_3_0";              # Subdirectory that untar'ing the 
                                  # SRB_FILE creates.
$ORACLE_HOME="/usr/local/apps/oracle/product/9.2.0";  # where Oracle library can be located
					    # IMPORTANT: your LD_LIBRARY_PATH must point to oracle library.
					    # We have assumed its already set outside.
